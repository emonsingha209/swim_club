...
<div class="d-flex justify-content-between mb-4">
    ...
    <a class="btn btn-primary btn-sm d-flex justify-content-center align-items-center" href="addrace">Add New Race</a>
    <?php endif; ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-success btn-sm" href="addraceresult?raceId=<?php echo $race['RaceID']; ?>">Add
                        Result</a>
                    <a class="btn btn-primary btn-sm" href="updaterace?raceId=<?php echo $race['RaceID']; ?>">Edit</a>
                    ...
                    <?php endif; ?>
                    <a class="btn btn-secondary btn-sm" href="raceresults?raceId=<?php echo $race['RaceID']; ?>">View
                        Result</a>
                </td>
            </tr>
            <?php endforeach; ?>
