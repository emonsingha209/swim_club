...
<div class="d-flex justify-content-between mb-4">
    ...
    <a class="btn btn-primary btn-sm d-flex justify-content-center align-items-center" href="addsquad">Add New Squad</a>
    <?php endif; ?>
</div>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-success btn-sm" href="squad?squadId=<?php echo $squad['squad_id']; ?>">View</a>
                    <a class="btn btn-primary btn-sm"
                        href="updatesquad?squadId=<?php echo $squad['squad_id']; ?>">Edit</a>
                    <?php if ($_SESSION['role'] == 'coach'): ?>
                    <a class="btn btn-secondary btn-sm" href="addsession?squadId=<?php echo $squad['squad_id']; ?>">Add
                        Training</a>
                    <?php endif; ?>
