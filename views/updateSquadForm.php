    ...
    <form action="sqdformupdate" method="POST">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="squad_name" name="squad_name"
                value="<?php echo $squad['squad_name']; ?>"
                <?php echo ($_SESSION['role'] != 'admin') ? 'disabled' : ''; ?> required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="<?php echo strtolower($day); ?>"
                    name="training_days[]" value="<?php echo $day; ?>" <?php echo $checked; ?>>
        ...
        <div class="mb-3">
            ...
            <input type="time" class="form-control" id="end_time" name="end_time"
                value="<?php echo $squad['end_time']; ?>" required>
        </div>
